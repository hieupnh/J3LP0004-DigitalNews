...
search Created on : Jan 17, 2019, 2:15:18 AM Author : hieupnh --%> <%@page
...
<html>
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="./public/css/search-page.css"
    />
    <title>Search</title>
  </head>
  <body>
              ...
              <c:forEach var="article" items="${listSearch}">
                <div>
                  <p class="text-4 text-blue mt-0 font-bold">
                    <a class="text-blue" href="viewarticle?id=${article.id}"
                      >${article.title}</a
                    >
                  </p>
                  <img
                  ...
                  <p class="text-gray mt-5 items-end text-right">
                    ${mostRecentArticle.author} |
                    ${mostRecentArticle.getDateFormat()}
                  </p>
                </div>
              </c:forEach>
