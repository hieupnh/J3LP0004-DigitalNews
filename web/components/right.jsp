<%-- Document : right Created on : Jan 17, 2019, 10:44:54 AM Author : hieupnh
    ...
    <div class="right py-5 pl-3 pr-5">
      ...
      <div>
        ...
        <form class="flex" method="POST" action="Search">
          ...
          <input
            type="submit"
            class="text-blue border-none bg-none"
            value="Go"
          />
        </form>
      </div>
      ...
      <div>
        ...
        <ul class="list-reset">
          <c:forEach var="article" items="${fiveRecentAticle}">
            <li class="mt-5">
              <a href="viewarticle?id=${article.id}" class="text-blue underline"
                >${article.title}</a
              >
            </li>
          </c:forEach>
